...
The category code display (subscripted number) may be incorrect for active characters that are also implicit character tokens, or \verb|\let| to an unexpandable token.
