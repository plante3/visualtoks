...
\long\def\visualtoks@cycleA#1#{%
	\visualtoks@cycleB\visualtoks@cycleD#1 \visualtoks@cycle@nil
	\visualtoks@cycle@nil \visualtoks@cycleE
}
...
\long\def\visualtoks@cycleC#1\fi#2\visualtoks@cycle@nil{\fi #1\visualtoks@cycle@nil}
\long\def\visualtoks@cycleD#1{%
	\ifx\visualtoks@cycle@nil#1\visualtoks@cycleG\fi
	\visualtoksA{#1}\visualtoks@cycleD
}
\long\def\visualtoks@cycleE#1{%
	\if\relax\detokenize\expandafter{\visualtoks@cycleF#1\visualtoks@cycle@nil}\relax \else \visualtoks@cycleG \fi
	\visualtoksA\visualtoks@cycle@bgroup
	\visualtoks@cycle{#1}%
	\visualtoksA\visualtoks@cycle@egroup
	\visualtoks@cycleA
}
\long\def\visualtoks@cycleF#1\visualtoks@cycle@nil{}
\long\def\visualtoks@cycleG#1\visualtoks@cycle@nil{\fi}
...
\protected\long\def\visualtoks#1{%
	\begingroup
		...
		\raggedright\frenchspacing\m@th
	...
	\else
		...
		\ifx\tempa\tempb \expandafter\visualtoks@firstoftwo \else \expandafter\visualtoks@secondoftwo \fi
			...
			{\visualtoksB{\string#1}%
				...
				\if\relax\detokenize\expandafter\expandafter\expandafter{\expandafter\tempa\expandafter#1\csname\string#1\endcsname}\relax *\fi
			}%
	\fi\fi\fi
}
