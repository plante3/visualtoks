...
\long\def\visualtoks@cycleA#1#{%
	\visualtoks@cycleB\visualtoks@cycleC#1 \visualtoks@cycle@nil
	\visualtoks@cycle@nil \visualtoks@cycleD
}
\long\def\visualtoks@cycleB#1#2 #3\visualtoks@cycle@nil{%
	\if\relax\detokenize{#3}\relax \expandafter\visualtoks@firstoftwo \else \expandafter\visualtoks@secondoftwo \fi
		{#1#2\visualtoks@cycle@nil}%
